...
FeedingSummary$Chamber <-as.character(english(FeedingSummary$Chamber))
...
FeedingSummary$Genotype <- recode_factor(FeedingSummary$Chamber, one = "Gal4 Control", two = "UAS Control", three = "Experimental", four = "Gal4 Control", five = "UAS Control", six = "Experimental")
...
#names the variable Genotype, and then runs a ifelse statement on chamber based on if it is odd or even, and labels odd as "control and even as "silencer"
ChoiceDurations$Genotype =  recode_factor(FeedingSummary$Chamber, one = "Gal4 Control", two = "Gal4 Control", three = "UAS Control", four = "UAS Control", five = "Experimental", six = "Experimental", seven = "Gal4 Control", eight = "Gal4 Control", nine = "UAS Control", ten = "UAS Control", eleven = "Experimental", twelve = "Experimental")
